...
# Start Function
def change_detection_daily_agg(data, prod_col, datetime_col, meter_col, solar_col):
...
# Import Data
data_in = open_unknown_csv("data_in.csv", ',')

# Start Function
# Assigning Function Variables
data_in = data_in
prod_col_in = "Production (KW)"
datetime_col_in = "Datetime"
meter_col_in = "Meter_ID"
solar_col_in = "Solar Irradiance"

# Run Function
data_out = change_detection_daily_agg(data_in, prod_col_in, datetime_col_in, meter_col_in, solar_col_in)

# Write meter day to csv
data_out.to_csv("test_out.csv", index=False)
